...
def main():
    ...
    generate_image_grid(f'trianing_runs/00000-cifar10-32x32-uncond-ddpmpp-edm-gpus2-batch512-fp32/network-snapshot-175616.pkl',   'cifar10-32x32.png',  num_steps=18) # FID = 1.79, NFE = 35
